...
public DEA_InOut(String inoutID, Vector<String> varname, Vector<String> varvalue, String res, Double c)
{
	inout = inoutID;
	resource = res;
	cost = c;
...
public void print()
{
System.out.println(inout+"--"+cost+"--"+resource+"--"+varName.toString()+"--"+varValue.toString());	
}

public void getUserInput(Connection con) throws Exception{
	//Vector<String> used_vars = new Vector<String>();
	String rbi_id = inout.replace("rbi","");
